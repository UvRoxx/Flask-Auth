...
app.config['SECRET_KEY'] = 'uv-auth-key'
    ...
    if request.method == 'POST':
        try:
            ...
            if check_password_hash(user.password, request.form['password']):
                print('success')
                current_user = load_user(user_id=user.id)
            ...
            flash("No Email Found with this id")
...
@login_required
def download():
    return send_from_directory("static/files/", filename='cheat_sheet.txt')
